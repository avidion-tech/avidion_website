      ...
      <div className="overflow-hidden bg-[#030104]">
        <div className="px-9 py-[46px] md:px-[50px] md:py-[80px] xl:px-[206px]">
          <div className="relative">
            ...
            <div className="absolute -right-1/4 top-0 size-[430px] animate-blob-2 rounded-full bg-[linear-gradient(120deg,_rgba(255,115,217,0.80)_0%,_rgba(234,62,187,0.80)_86.07%)] opacity-[0.28] blur-[112px] will-change-transform md:right-0 md:size-[730px]"></div>
